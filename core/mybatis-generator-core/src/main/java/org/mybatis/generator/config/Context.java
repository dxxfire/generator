...
public class Context extends PropertyHolder {
   ...
   * validating that database tables exist or validating that named columns
   * exist
   * 
   * @param errors
   *          errors
   ...
   *          <code>null</code>
   * @param warnings
   *          any warning generated from this method will be added to the List.
   *          Warnings are always Strings.
   * @param fullyQualifiedTableNames
   *          a set of table names to generate. The elements of the set must be
   *          Strings that exactly match what's specified in the configuration.
   *          For example, if table name = "foo" and schema = "bar", then the
   *          fully qualified table name is "foo.bar". If the Set is null or
   *          empty, then all tables in the configuration will be used for code
   *          generation.
   * 
   * @throws SQLException
   *           if some error arises while introspecting the specified database
   *           tables.
