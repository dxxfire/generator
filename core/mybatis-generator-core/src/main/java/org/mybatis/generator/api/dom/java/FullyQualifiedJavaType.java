...
public class FullyQualifiedJavaType implements
   ...
   * 
   * This method calculates the package as the part of the fully qualified name
   * up to, but not including, the last element. Therefore, it does not support
   * fully qualified inner classes. Not totally fool proof, but correct in most
   * instances.
   * 
